...
SAMPLE_SPREADSHEET_ID = '1Ise8zJkIX91XAnEBVrduFuha2kWdYqjuVdbOnvQGAh8'
SAMPLE_RANGE_NAME = 'Página1!A1:E7'


def main():
    creds = None # Credênciais
    ...
    try:
        ...
        values = result.get('values', []) # Pega apenas valores
